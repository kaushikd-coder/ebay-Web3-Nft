...
function Header({ }: Props) {
    //crete the instances for using the hooks
    ...
    return (
        <div className='max-w-6xl mx-auto p-2'>
            <nav className='flex justify-between'>
                ...
                <div className='flex space-x-4 mx-5 items-center text-sm'>
            ...
            <section className='flex items-center space-x-2 py-5'>
                ...
                <div className=' h-1/6 my-2 flex items-center space-x-2 px-2 md:px-5 py-2  border-black border-2 flex-1'>
            ...
            <hr />
            <section className='flex py-2 space-x-6 text-sm md:text-sm whitespace-nowrap justify-center px-6'>
